...
import com.laotabu.activiti.mapper.ActWorkflowFormDataMapper;
...
public class ActWorkflowFormDataServiceImpl implements IActWorkflowFormDataService
{
    ...
    public int insertActWorkflowFormDatas(List<ActWorkflowFormData> ActWorkflowFormDatas) {
        return actWorkflowFormDataMapper.insertActWorkflowFormDatas(SecurityUtils.getUsername(), ActWorkflowFormDatas, new Date(),SecurityUtils.getUsername());
    }
