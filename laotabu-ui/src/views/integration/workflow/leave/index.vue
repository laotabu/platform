...
<script>
  import {listLeave, getLeave, delLeave, addLeave, updateLeave, exportLeave} from '@/api/integration/workflow/leave'
  import {getUserProfile} from '@/api/system/user'
  import {getDefinitionsByInstanceId} from '@/api/activiti/definition'


  import leaveHistoryForm from "./form/leaveHistoryForm";
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd() {
        ...
        if (this.$store.getters.nickName != "admin") {
          this.reset()
          this.open = true
          this.title = '添加请假'
        } else {
